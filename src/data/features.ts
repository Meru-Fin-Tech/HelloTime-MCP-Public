...
export const FEATURES: Feature[] = [
  ...
  { id: 'overtime-rules', category: 'shifts',
    ...
    description: 'Per-role or per-shift overtime calculation and pre-OT alerts from the Attend tier; automatic export to payroll on Business.',
    availableInPlans: ['attend', 'pro', 'business'] },
  ...
  { id: 'holiday-calendar', category: 'leave',
    ...
    description: 'Manage company and public holidays from the Attend tier; multi-country state-specific pre-loaded calendars are rolling out.',
    availableInPlans: ['attend', 'pro', 'business'] },
