...
const GB_RATES: StatutoryRate[] = [
  ...
  {
    id: 'gb-scottish-income-tax-2025',
    country: 'GB',
    scheme: 'SRIT',
    label: 'Scottish Income Tax (SRIT) bands — Scotland 2025-26',
    category: 'income-tax',
    party: 'employee',
    rateType: 'slab',
    slabs: [
      { upTo: 12570, rate: 0, note: 'Personal allowance — £12,570 (UK-wide, frozen through 2027-28).' },
      { upTo: 14876, rate: 0.19, note: 'Starter rate — £12,571 to £14,876 (threshold +3.5% for 2025-26).' },
      { upTo: 26561, rate: 0.20, note: 'Basic rate — £14,877 to £26,561 (threshold +3.5% for 2025-26).' },
      { upTo: 43662, rate: 0.21, note: 'Intermediate rate — £26,562 to £43,662.' },
      { upTo: 75000, rate: 0.42, note: 'Higher rate — £43,663 to £75,000 (threshold frozen).' },
      { upTo: 125140, rate: 0.45, note: 'Advanced rate — £75,001 to £125,140 (threshold frozen).' },
      { upTo: null, rate: 0.48, note: 'Top rate — above £125,140 (threshold frozen).' },
    ],
    appliedTo: 'Annual taxable income for Scottish taxpayers (residence-based, not employer-based)',
    authority: 'Scottish Government (rates set by Scottish Parliament; HMRC collects via PAYE with code prefix S)',
    source: 'https://www.gov.scot/publications/scottish-income-tax-rates-and-bands/pages/proposed-rates-and-bands-2025-to-2026/',
    effectiveFrom: '2025-04-06',
    ...GB_VERIFIED,
    notes: [
      'Scotland operates 6 income-tax bands; England/Wales/NI operate 3 (see `gb-paye-income-tax-2025`).',
      'PAYE tax code starts with "S" for Scottish taxpayers. Residency determined by main place of residence over the tax year, not by employer location.',
      'Higher / Advanced / Top thresholds frozen through 2026-27 per Scottish Budget 2025-26.',
      'Personal allowance £12,570 is reserved/set UK-wide and tapers £1 per £2 of income above £100,000 — same as r-UK.',
      'Scottish dividend and savings rates remain UK-wide (set by Westminster).',
    ],
  },
];
...
const CA_RATES: StatutoryRate[] = [
  ...
  },
  {
    ...
    notes: [
      ...
      'Provincial / territorial income tax stacks on top of federal — Ontario and Alberta included as separate entries (`ca-on-income-tax-2025`, `ca-ab-income-tax-2025`); QC / BC / MB / NS / NB / NL / PEI / SK / YT / NT / NU still STUB.',
      'Quebec administers its own provincial income tax directly (not via CRA) — separate filing path; not yet modelled.',
  ...
  {
    id: 'ca-on-income-tax-2025',
    country: 'CA',
    scheme: 'OntarioIncomeTax',
    label: 'Ontario provincial income tax brackets — 2025',
    category: 'income-tax',
    party: 'employee',
    rateType: 'slab',
    slabs: [
      { upTo: 52886, rate: 0.0505, note: 'First $52,886 of taxable income (indexed +2.8% from 2024).' },
      { upTo: 105775, rate: 0.0915, note: '$52,886.01 to $105,775.' },
      { upTo: 150000, rate: 0.1116, note: '$105,775.01 to $150,000 (threshold not indexed).' },
      { upTo: 220000, rate: 0.1216, note: '$150,000.01 to $220,000 (threshold not indexed).' },
      { upTo: null, rate: 0.1316, note: 'Above $220,000.' },
    ],
    appliedTo: 'Annual Ontario taxable income (residents)',
    state: 'Ontario',
    authority: 'Ontario Ministry of Finance (CRA collects via T1 alongside federal)',
    source: 'https://data.ontario.ca/dataset/personal-income-tax-rates-and-credits',
    effectiveFrom: '2025-01-01',
    ...CA_VERIFIED,
    notes: [
      'Ontario brackets stack on top of federal — combined top marginal is ~46.16% (33% federal + 13.16% Ontario) on income above $253,414.',
      'Ontario Basic Personal Amount (BPA) for 2025 = $12,747; tapers to $0 at high incomes via the Ontario Surtax.',
      'Ontario Surtax: additional 20% of ON tax above $5,710 + extra 36% of ON tax above $7,307 (so effective top rate can exceed 13.16% on the highest earners). Not modelled in the slabs above.',
      'Ontario Health Premium (a separate provincial levy on annual taxable income, $0 to $900) is also stacked but is collected via the same T1.',
    ],
  },
  {
    id: 'ca-ab-income-tax-2025',
    country: 'CA',
    scheme: 'AlbertaIncomeTax',
    label: 'Alberta provincial income tax brackets — 2025',
    category: 'income-tax',
    party: 'employee',
    rateType: 'slab',
    slabs: [
      { upTo: 60000, rate: 0.08, note: 'NEW bracket from 01-Jan-2025 — 8% on first $60,000 (previously a flat 10% on this band).' },
      { upTo: 151234, rate: 0.10, note: '$60,000.01 to $151,234 (indexed from 2024\'s $148,269).' },
      { upTo: 181481, rate: 0.12, note: '$151,234.01 to $181,481 (indexed from 2024\'s $177,922).' },
      { upTo: 241974, rate: 0.13, note: '$181,481.01 to $241,974 (indexed from 2024\'s $237,230).' },
      { upTo: 362961, rate: 0.14, note: '$241,974.01 to $362,961 (indexed from 2024\'s $355,845).' },
      { upTo: null, rate: 0.15, note: 'Above $362,961.' },
    ],
    appliedTo: 'Annual Alberta taxable income (residents)',
    state: 'Alberta',
    authority: 'Government of Alberta (CRA collects via T1 alongside federal)',
    source: 'https://www.alberta.ca/personal-income-tax',
    effectiveFrom: '2025-01-01',
    ...CA_VERIFIED,
    notes: [
      'Alberta moved from a 5-bracket structure (10/12/13/14/15%) to 6 brackets on 01-Jan-2025 by adding a new 8% bracket on the first $60,000 — Budget 2025 tax cut worth up to $750/year per taxpayer.',
      'Alberta Basic Personal Amount (BPA) for 2025 = $22,323 — one of the highest in Canada.',
      'Combined top marginal is ~48% (33% federal + 15% Alberta) on income above $362,961.',
      'Thresholds indexed annually to Alberta CPI from 2022 onwards; the $60,000 new-bracket threshold was set in nominal dollars and may not index until 2026.',
    ],
  },
];
...
const SG_RATES: StatutoryRate[] = [
  ...
  {
    id: 'sg-cpf-spr-y1-gg-employer-under-55-2025',
    country: 'SG',
    scheme: 'CPF',
    label: 'CPF — SPR 1st year, graduated employer (G/G), age ≤ 55 (2025)',
    category: 'social-security',
    party: 'employer',
    rateType: 'percentage',
    rate: 0.04,
    appliedTo: 'Ordinary Wages up to OW ceiling SGD 7,400/month (2025); 1st year of Singapore PR status',
    wageCeiling: 7400,
    authority: 'CPF Board',
    source: 'https://www.cpf.gov.sg/content/dam/web/employer/employer-obligations/documents/CPF_contribution_rates_from_1_Jan_2025.pdf',
    effectiveFrom: '2016-01-01',
    ...SG_VERIFIED,
    notes: [
      'Graduated rate applies for the first 24 months after a worker obtains Singapore Permanent Resident status (year 1 G/G + year 2 G/G).',
      'Employer + employee may jointly elect F/G (full employer 17% + graduated employee 5% = 22%) by joint application to CPF Board.',
      'After 24 months (3rd year onwards) rates flip to the standard citizen / 3rd-year-PR table — see `sg-cpf-employer-under-55-2025`.',
      'Senior-tier SPR rates (55-60, 60-65, 65-70, >70) step down further per the CPF Board PDF — not modelled here as ≤55 covers the vast majority of new SPRs.',
    ],
  },
  {
    id: 'sg-cpf-spr-y1-gg-employee-under-55-2025',
    country: 'SG',
    scheme: 'CPF',
    label: 'CPF — SPR 1st year, graduated employee (G/G), age ≤ 55 (2025)',
    category: 'social-security',
    party: 'employee',
    rateType: 'percentage',
    rate: 0.05,
    ...
    ...SG_VERIFIED,
    notes: [
      'Combined SPR 1st-year G/G under-55 total contribution = 9% (4% employer + 5% employee).',
      'No employee contribution required if total wages for the month are ≤ SGD 500.',
    ],
  },
  {
    id: 'sg-cpf-spr-y2-gg-employer-under-55-2025',
    country: 'SG',
    scheme: 'CPF',
    label: 'CPF — SPR 2nd year, graduated employer (G/G), age ≤ 55 (2025)',
    category: 'social-security',
    party: 'employer',
    rateType: 'percentage',
    rate: 0.09,
    appliedTo: 'Ordinary Wages up to OW ceiling SGD 7,400/month (2025); 2nd year of Singapore PR status',
    wageCeiling: 7400,
    authority: 'CPF Board',
    source: 'https://www.cpf.gov.sg/content/dam/web/employer/employer-obligations/documents/CPF_contribution_rates_from_1_Jan_2025.pdf',
    effectiveFrom: '2016-01-01',
    ...SG_VERIFIED,
    notes: [
      'SPR 2nd-year G/G is the default — step up from 1st-year G/G as the worker matures into the citizen rate over 24 months.',
      'F/G option also available in year 2: full employer 17% + graduated employee 15% = 32%.',
    ],
  },
  {
    id: 'sg-cpf-spr-y2-gg-employee-under-55-2025',
    country: 'SG',
    scheme: 'CPF',
    label: 'CPF — SPR 2nd year, graduated employee (G/G), age ≤ 55 (2025)',
    category: 'social-security',
    party: 'employee',
    rateType: 'percentage',
    rate: 0.15,
    ...
    ...SG_VERIFIED,
    notes: [
      'Combined SPR 2nd-year G/G under-55 total contribution = 24% (9% employer + 15% employee).',
      'No employee contribution required if total wages for the month are ≤ SGD 500.',
    ],
  },
];
...
const AE_RATES: StatutoryRate[] = [
  ...
  {
    id: 'ae-eosg-legacy-unlimited-resignation-1-3yr',
    country: 'AE',
    scheme: 'EOSG-Legacy',
    label: 'Legacy gratuity (pre-2022) — unlimited contract, resignation after 1–3 years (1/3 paid)',
    category: 'end-of-service',
    party: 'employer',
    rateType: 'percentage',
    rate: 0.01918,
    appliedTo: 'Basic salary per completed year of service — 1/3 of the standard 21-day accrual (21 × (1/3) / 365 ≈ 1.92%)',
    authority: 'Ministry of Human Resources and Emiratisation (MOHRE) — Federal Law 8 of 1980 (superseded)',
    source: 'https://natlex.ilo.org/dyn/natlex2/natlex2/files/download/11956/ARE11956.pdf',
    effectiveFrom: '1980-01-01',
    ...AE_VERIFIED,
    notes: [
      'HISTORICAL REFERENCE. Federal Law 8 of 1980 was superseded by Federal Decree-Law 33 of 2021 on 02-Feb-2022; all employees migrated to fixed-term (limited) contracts and the resignation-reduction ladder below no longer applies to new termination events.',
      'Unlimited-contract resignation, 1-3 years service: gratuity reduced by 2/3 (only 1/3 of the standard 21-day accrual paid).',
      'For terminations BEFORE 02-Feb-2022 still being computed in arrears, use this rate; for any termination on/after that date use the current `ae-eosg-first-5-years` / `ae-eosg-years-above-5` entries.',
      'Cap of 2 years\' basic salary still applies.',
    ],
  },
  {
    id: 'ae-eosg-legacy-unlimited-resignation-3-5yr',
    country: 'AE',
    scheme: 'EOSG-Legacy',
    label: 'Legacy gratuity (pre-2022) — unlimited contract, resignation after 3–5 years (2/3 paid)',
    category: 'end-of-service',
    party: 'employer',
    rateType: 'percentage',
    rate: 0.03836,
    appliedTo: 'Basic salary per completed year of service — 2/3 of the standard 21-day accrual (21 × (2/3) / 365 ≈ 3.84%)',
    authority: 'Ministry of Human Resources and Emiratisation (MOHRE) — Federal Law 8 of 1980 (superseded)',
    source: 'https://natlex.ilo.org/dyn/natlex2/natlex2/files/download/11956/ARE11956.pdf',
    effectiveFrom: '1980-01-01',
    ...AE_VERIFIED,
    notes: [
      'HISTORICAL REFERENCE. Federal Law 8 of 1980 superseded 02-Feb-2022.',
      'Unlimited-contract resignation, 3-5 years service: gratuity reduced by 1/3 (2/3 of the standard 21-day accrual paid).',
      'After 5 years of service on an unlimited contract, resignation gratuity is paid at the full 21-day rate (and 30-day rate from year 6 onwards) — at which point it matches the current `ae-eosg-*` entries.',
      'Cap of 2 years\' basic salary applies.',
    ],
  },
];
